...
def get_system_info():
   return {"os": platform.system(), "node": platform.node(), "release": platform.release(), "machine": platform.machine()}  
...
def get_directory_info(path):
   return {"path": os.path.abspath(path), "exists": os.path.exists(path), "file_count": len(os.listdir(path)), "is_directory": os.path.isdir(path)}
